...
DROP VIEW IF EXISTS vw_AllProductReviews;
GO
...
-- Insert data into the Products table, including the Price column
INSERT INTO Products (ProductName, ProductDescription, ScentID, ColorID, MaterialID, Price, ProductImagePath) VALUES
('Tranquil Lavender Meadows', 'Calming lavender for serenity. Made with premium soy wax.', 1, 1, 1, 19.99, '/images/ProductImages/Citrus.jpg'),
('Vanilla Bean Comfort', 'Warm, inviting vanilla bean aroma. Perfect for creating a sense of home.', 2, 2, 1, 24.99, '/images/ProductImages/Crisp.jpg'),
('Citrus Zest Revival', 'Energizing citrus blend to refresh any room.', 3, 3, 2, 17.99, '/images/ProductImages/Earthy.jpg'),
('Earthy Sandalwood Serenity', 'Grounding sandalwood aroma for peace.', 4, 4, 2, 21.99, '/images/ProductImages/Refreshing.jpg'),
('Crisp White Linen Breeze', 'The scent of freshly laundered linens.', 5, 5, 3, 14.99, '/images/ProductImages/Tranquil.jpg'),
('Refreshing Ocean Mist', 'Breezy and light, capturing the essence of the ocean.', 6, 6, 3, 18.99, '/images/ProductImages/Vanilla.jpg');
...
CREATE VIEW vw_AllProductReviews AS
SELECT 
    p.ProductID, 
 --   p.ProductName, 
 --   p.ProductDescription,
...
SELECT * FROM vw_AllProductReviews
GO